<template>
  ...
  <div>
    ...
    item
    on
    the results list in the search window. To do so, first create an
    item
    type
    to
    ...
    <ol>
      <li>
        In the .cs file add
        <br />
        <textarea readonly style="height: 5vh;">
  ...
  <div>
    ...
    <ul>
      ...
      <li>an Icon</li>
      <li>
        an Execute method to define what should happen when a list
        item
        is
        run
