import{M as v}from"./BfnaNJmi.js";import{M as w}from"./CSq7ABl5.js";import{h as y,n as c,K as b,c as C,a,d as o,b as t,w as r,o as k,e as x,j as _,i as d}from"./CQKN6VTH.js";import{_ as A}from"./M0DEZ8rh.js";import{M as T}from"./BA1o4RiI.js";import{c as E,M}from"./cSVCS8Kn.js";import{L as z}from"./1aRuElDn.js";import{u as S}from"./DahswL0y.js";import"./Cpj98o6Y.js";const I={class:"text-center mt-42 varela"},F={class:"w-full px-78 mb-4 mt-16 outfit"},j=y({__name:"index",setup(B){c(!0);const n=c(`# Contributor Covenant: Code of Conduct
...
characteristics including race, ethnicity, caste, color, age, physical characteristics,
...
When an incident does occur, it is important to report it promptly using the [Quokka Code of Conduct Issue Form](https://cryptpad.fr/form/#/2/form/view/Vfi8EMSHXAevFBlk-oFcfx2hAxUE1ao1sj2E3D2RclE/embed/).
The responses are viewable only by the Quokka team.

The team takes reports of violations seriously and will make every effort to
 respond in a timely manner. They will investigate all reports of code of conduct
  violations, reviewing messages, logs, and recordings, or interviewing
   witnesses and other participants.

   The team will keep investigation and enforcement actions as transparent as
    possible while prioritizing safety and confidentiality. In order to honor
     these values, enforcement actions are carried out in private with the
...
If an investigation by the team finds that this Code of Conduct has been violated,
...
1) Warning
   ...
   | Consequence | A private, written warning from the team                       |
...
3) Temporary Suspension
   ...
   | Attribute   | Description                                                    |
   | ----------- | -------------------------------------------------------------- |
   | Event | A pattern of repeated violation which the team have tried to address with warnings, or a single serious violation |
...
4) Permanent Ban
   ...
   | Attribute   | Description                                                    |
   | ----------- | -------------------------------------------------------------- |
   | Event | A pattern of repeated code of conduct violations that other steps on the ladder have failed to resolve, or a violation so serious that the team determine there is no way to keep the community safe with this person as a member |
...
It does not limit the ability of the team to use their discretion and judgment, in keeping with the best interests of our community.
...
The enforcement ladder was inspired by the work of [Mozilla’s code of conduct team](https://github.com/mozilla/inclusion).
  `);n.value=n.value.substring(n.value.indexOf(`
`)+1),E({markdownItPlugins(s,{editorId:e}){return[{type:"linkAttr",plugin:z,options:{matcher(i){return!i.startsWith("#")},attrs:{target:"_blank"}}}]}});const{colorMode:l}=S(),m=c(l.value);return b(l,async(s,e)=>m.value=s.toString()),(s,e)=>{const i=v,p=w,u=_,h=x,g=A,f=T;return k(),C("div",null,[a("div",I,[t(i,{direction:"up",delay:200,duration:700},{default:r(()=>e[0]||(e[0]=[a("span",{class:"text-6xl"},"Contributor Covenant: Code of Conduct",-1)])),_:1,__:[0]}),e[1]||(e[1]=o()),t(p,{tag:"h1",text:"Fostering an open, welcoming, and safe environment for all contributors.",delay:400,duration:1500,direction:"up","column-gap":.3,"row-gap":.3,class:"text-gray-500 dark:text-gray-400 mt-4"})]),e[7]||(e[7]=o()),a("div",F,[t(i,{direction:"up",delay:1050,duration:700},{default:r(()=>[t(f,{class:"min-h-[40vh] w-full"},{default:r(()=>[t(h,{to:"https://github.com/Faeq-F/Quokka/blob/main/CODE_OF_CONDUCT.md",class:"!no-underline flex items-center !not-italic"},{default:r(()=>[t(u,{name:"i-lucide-book-open",class:"mr-1.5 !size-4"}),e[2]||(e[2]=o()),e[3]||(e[3]=a("code",null,"CODE_OF_CONDUCT.md",-1)),e[4]||(e[4]=o()),t(u,{name:"i-lucide-arrow-up-right",class:"!size-2 mb-1"})]),_:1,__:[2,3,4]}),e[5]||(e[5]=o()),t(g,{class:"my-3",ui:{border:"dark:border-gray-600"}}),e[6]||(e[6]=o()),t(d(M),{theme:d(m),previewTheme:"github",codeTheme:"github",language:"en-US",class:"!bg-transparent",modelValue:d(n)},null,8,["theme","modelValue"])]),_:1,__:[5,6]})]),_:1})])])}}});export{j as default};
