import{M as b}from"./B2lnu9ZN.js";import{M as k}from"./BUeu4JPp.js";import{h as w,n as u,K as v,c as _,a as i,d as o,b as t,w as r,o as y,e as x,j as T,i as c}from"./VWh9Xf4C.js";import{_ as I}from"./Cz0dVq_u.js";import{M as C}from"./D0AnyHOt.js";import{c as M,M as j}from"./gMLhpm07.js";import{L as Q}from"./1aRuElDn.js";import{u as A}from"./CY7nffJE.js";import"./Cpj98o6Y.js";const N={class:"text-center mt-42 varela"},q={class:"w-full px-78 mb-4 mt-16 outfit"},W=w({__name:"index",setup(z){u(!0);const n=u(`# Contributing to Quokka
...
`)+1),M({markdownItPlugins(s,{editorId:e}){return[{type:"linkAttr",plugin:Q,options:{matcher(a){return!a.startsWith("#")},attrs:{target:"_blank"}}}]}});const{colorMode:l}=A(),m=u(l.value);return v(l,async(s,e)=>m.value=s.toString()),(s,e)=>{const a=b,h=k,d=T,g=x,p=I,f=C;return y(),_("div",null,[i("div",N,[t(a,{direction:"up",delay:200,duration:700},{default:r(()=>e[0]||(e[0]=[i("span",{class:"text-6xl"},"Contributing",-1)])),_:1,__:[0]}),e[1]||(e[1]=o()),t(h,{tag:"h1",text:"Help shape the future of this project",delay:400,duration:1500,direction:"up","column-gap":.3,"row-gap":.3,class:"text-gray-500 dark:text-gray-400 mt-4"})]),e[7]||(e[7]=o()),i("div",q,[t(a,{direction:"up",delay:900,duration:700},{default:r(()=>[t(f,{class:"min-h-[40vh] w-full"},{default:r(()=>[t(g,{to:"https://github.com/Faeq-F/Quokka/blob/main/CONTRIBUTING.md",class:"!no-underline flex items-center !not-italic"},{default:r(()=>[t(d,{name:"i-lucide-book-open",class:"mr-1.5 !size-4"}),e[2]||(e[2]=o()),e[3]||(e[3]=i("code",null,"CONTRIBUTING.md",-1)),e[4]||(e[4]=o()),t(d,{name:"i-lucide-arrow-up-right",class:"!size-2 mb-1"})]),_:1,__:[2,3,4]}),e[5]||(e[5]=o()),t(p,{class:"my-3",ui:{border:"dark:border-gray-600"}}),e[6]||(e[6]=o()),t(c(j),{theme:c(m),previewTheme:"github",codeTheme:"github",language:"en-US",class:"!bg-transparent",modelValue:c(n)},null,8,["theme","modelValue"])]),_:1,__:[5,6]})]),_:1})])])}}});export{W as default};
