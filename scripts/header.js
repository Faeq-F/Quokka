...
function getColors() {
  ...
  colors = [
    {
      front: bodyComputedStyle.getPropertyValue("--primary"),
      back: bodyComputedStyle.getPropertyValue("--primary"),
    },
    {
      front: bodyComputedStyle.getPropertyValue("--primaryOther"),
      back: bodyComputedStyle.getPropertyValue("--primaryOther"),
    },
    {
      front: bodyComputedStyle.getPropertyValue("--primaryOtherOther"),
      back: bodyComputedStyle.getPropertyValue("--primaryOtherOther"),
    },
  ];
}
