  ...
  <div class="flex flex-row">
    <div class="basis-1/4 pt-4 px-4">
      <MazAnimatedElement direction="down" :delay="500" :duration="2000"
        class="" v-for="(s, i) in docsTOC.toc" :key="i">
        <MazBtn color="transparent" @click="switchSection(s.section)"
          ...
          <MazCardSpotlight class="w-full">
            <MazAnimatedElement direction="right" :delay="1900" :duration="2000"
    ...
    <div class="basis-3/4 content max-h-[90vh] overflow-y-scroll">
      <h1>
      ...
      <div>
        ...
        Add exclusions to any other anti-malware software that is installed on
        your
      ...
      <div>
        ...
        <ul>
          ...
          <li>You may also want to set up a task to run the program at startup
            in
            Task Scheduler. Alternatively see the <a href=''>FAQ</a> on this.
          </li>
        </ul>
      </div>
      <h1>
      ...
      <div>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>This shortcut is modifiable; see <a href="">the
                    ContextPaneKey
                    setting</a></td>
              </tr>
            </tbody>
        ...
        <div>
          You can change which file manager opens the plugboard folder through
        ...
        <div>
          ...
          Please see their folder in the PlugBoard to find their settings file
          (at
        ...
        <div>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td>▢</td>
                <td>workflows - launch multiple shortcuts at once - see below
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div>
        ...
        To change it, you can edit the style settings in the settings file or
        you
      ...
      <div>
        All settings are loaded when the application starts, meaning that you
        will
        have to exit and re-start the app to see changes.
      </div>
      <div>
        Plugins may have their own, specific settings files in the root of their
        respective folders in the PlugBoard. You can open The PlugBoard using
        the
          ...
          <tbody>
            <tr>
              ...
              <td>The default value is interpreted as 'Left Windows key +
                Spacebar'<br /><br />The full list of keys that can be used in
                the
            ...
            <tr>
              ...
              <td>The program that will open the settings file. Plugins may use
                this setting to open other files, for e.g., their own settings
                file
              </td>
      ...
      <div>
        <ol>
          ...
          <li>
            Copy the Quokka folder (in build path - normally 'bin') to your
            desired
      ...
      <div>
        ...
        <div>
          ...
          <ol>
            ...
            <li>
              ...
              naming it
              "Plugin_YourPluginNameHere" (make sure that it is a part of the
              Quokka
        ...
        <div>
          Most plugins will want to show results to the user in the form of an
          item
          on
          the results list in the search window. To do so, first create an item
          type
          to
        ...
        <div>
          ...
          <ul>
            ...
            <li>an Icon</li>
            <li>
              an Execute method to define what should happen when a list item is
              run
        ...
        <div>
          ...
          All plugins need their own context panes. It is up to you whether or
          not
          they
    ...
    ">
        ...
        <div>
          If your context pane is visible, you may want to add extra information
          or
        ...
        <div>
          OnQueryChange is the method that is called by the SearchWindow when a
          user
          types in a query In this method, you should create your list item
          objects,
          filter them (if needed), and return them in a list.
          <br /><br />
          If your plugin has a special command, then you will need to sort the
          list
          for
          that command yourself. Normal results (those returned in
          OnQueryChange) do
          not
          need to be sorted as Quokka will sort them once it has results from
          all of
          the
      ...
      <div>
        ...
        to
        load the
        library at runtime and use the classes it provides. You can have a look
        at
